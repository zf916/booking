    ...
    .main-certification
        ...
        .form-content
            <el-table stripe :data="items" style="width: 100%" highlight-current-row @current-change="handleCurrentRow">
                ...
                <el-table-column prop="lastmodifiedTime" label="更新时间"></el-table-column>
                <el-table-column prop="professionName" label="工种名称"></el-table-column>
                ...
                <el-table-column label="操作" width="260">
                    <template slot-scope="scope">
                        <el-button class="tb-btn" size="mini" @click="handlePrint(scope)">打印健康证</el-button>
                    </template>
                </el-table-column>
            </el-table>
...
export default {
    ...
    methods: {
        handleList(params=this.ruleForm) {
            this.$post( 'orderManage/getPushReportList', qs.stringify(params),{'Content-Type':'application/x-www-form-urlencoded'}).then(data => {
                this.items = data
