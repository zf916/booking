        ...
        .form-content
            ...
            .form-main
                <el-form :inline="true" :model="ruleForm" ref="ruleForm" label-width="120px">
                    ...
                    <el-form-item v-if="ruleForm.result == 'N'" label="痢疾杆菌" prop="shigella">
                        <el-select v-model="ruleForm.shigella" size="small" placeholder="请选择">
                    ...
                    <el-form-item v-if="ruleForm.result == 'N'" label="伤寒或副伤寒" prop="typhoid">
                        <el-select v-model="ruleForm.typhoid" size="small" placeholder="请选择">
                            <el-option label="合格" :value="1"></el-option>
                            <el-option label="不合格" :value="2"></el-option>
                        </el-select>
                    </el-form-item>
...
export default {
    ...
    methods: {
        submitForm() {
            ...
            this.$post('/examinationManage/resultAnals', params).then(data => {
